...
internal class SendImageToTelegramBotMultipleFiles
{
    internal static async Task SendMultipleFiles()
    {
        var botClient = new TelegramBotClient(Settings.BotClientId);

        using CancellationTokenSource cts = new();

        var chatId = -1001638798699;
        ...
        foreach (string filePath in imagesPath)
        {
            ...
            // Pause for 5 seconds before sending the next request
